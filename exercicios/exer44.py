# Programa que recebe um valor de compras e comforme a escolha, retorna quanto a pessoa vai pagar

doug = "LOJAS DOUG"
print(f'{doug:=^40}') # o :^40, faz a centralização do texto na tela
